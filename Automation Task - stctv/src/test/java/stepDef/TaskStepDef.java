...
public class TaskStepDef {
    SubscribeEngPage subscribeKSAEngPage = new SubscribeEngPage();
    ...
    public void theSubscribePageForKuwaitOpens() {
        subscribeKSAEngPage.clickOnCountriesArrow();
        subscribeKSAEngPage.selectKuwait();
    }

    @Given("the subscribe page for Bahrain opens")
    public void theSubscribePageForBahrainOpens() {
        subscribeKSAEngPage.clickOnCountriesArrow();
